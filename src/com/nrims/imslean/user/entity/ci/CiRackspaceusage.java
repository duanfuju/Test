...
public class CiRackspaceusage extends ShareField implements Serializable {
 	private String rack_id;
	private Integer rackusage_startu;
	private Integer rackusage_endu;
	...
	public void setRackusageStartu(Integer rackusage_startu){
		this.rackusage_startu=rackusage_startu;
	}
	public Integer getRackusageStartu(){
		return rackusage_startu;
	}
	public void setRackusageEndu(Integer rackusage_endu){
		this.rackusage_endu=rackusage_endu;
	}
	public Integer getRackusageEndu(){
		return rackusage_endu;
	}
