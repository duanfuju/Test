...
public class CiRackspaceusable extends ShareField implements Serializable {
 	private String rack_id;
	private Integer rackuasble_startu;
	private Integer rackuasble_endu;
	...
	public void setRackuasbleStartu(Integer rackuasble_startu){
		this.rackuasble_startu=rackuasble_startu;
	}
	public Integer getRackuasbleStartu(){
		return rackuasble_startu;
	}
	public void setRackuasbleEndu(Integer rackuasble_endu){
		this.rackuasble_endu=rackuasble_endu;
	}
	public Integer getRackuasbleEndu(){
		return rackuasble_endu;
	}
